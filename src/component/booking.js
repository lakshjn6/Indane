...
export default function Booking(){
    return (
        <div>
         <img src="booking.png" alt="image1" className="bookingimage"></img>
         <div className="outerdiv">
         <div className="innerelement" 
     onClick={() => window.location.href = 'https://wa.me/917588888824?text=I%20want%20to%20book%20a%20cylinder'} 
...
<div className="innerelement" 
     onClick={() => window.location.href = 'sms:+917718955555?body=I%20want%20to%20book%20a%20cylinder'} 
     style={{ cursor: 'pointer' }}>
        <div id="bookinglogo">
    <img width="50" height="50" src="https://img.icons8.com/ios/50/sms.png" alt="sms"  />
    ...
    <div>
        ...
        <p id="bookingstate">Book your cylinder instantly via SMS! 🚀 Tap here to order now!</p>
            ...
            <div className="innerelement" onClick={() => window.location.href = 'tel:+91 8454955555'} style={{ cursor: 'pointer' }}>
            <div id="bookinglogo">
    ...
    <div>
        ...
        <p id="bookingstate">Book your cylinder instantly via Missed Call! 🚀 Tap here to order now!</p>
            ...
            <div className="innerelement">
            <div id="bookinglogo">
            <img width="32" height="32" src="https://img.icons8.com/windows/32/women-s-portal--v1.png" alt="women-s-portal--v1"/>
             </div>
            <div>
<h1>Portal</h1>
