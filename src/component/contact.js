...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert("Your query has been submitted and emailed!");
        setFormData({
          customerNumber: "",
          phoneNumber: "",
          place: "",
          query: "",
          email: "", // clear email field too
        });
      } else {
          ...
          <div className="innerdiv1">
            <div id="innerdiv11">
              <div className="contactinfo">
                <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#ffffff" id="iconimage">
              ...
              <div className="contactinfo">
                ...
                Sirohi Road , Jhilai<br />Teh-Niwai,Tonk
              </div>
            </div>
            <div>
              <img src="call_cartoon.png" alt="pic" id="cartoon" />
            </div>
          </div>
